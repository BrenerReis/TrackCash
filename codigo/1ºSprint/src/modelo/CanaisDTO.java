...
public class CanaisDTO {
    ...
    private String nome, canal, senha, token, tipo, usuario, tipoadm, autentica, canalamd;
    ...
    public String getCanalamd() {
        return canalamd;
    }

    public void setCanalamd(String canalamd) {
        this.canalamd = canalamd;
    }
    private int id;
