...
public class Tela11_user extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Plataforma/ ERP", "Market Place", "Meio de pagamento" }));
    ...
    private void txtTipoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_txtTipoItemStateChanged
       Connection conn;
        ResultSet rs;
        String tipo;
        txtCanal.removeAllItems();
        
        tipo = txtTipo.getSelectedItem().toString();
        
       
        String sql = "select * from canaladm where tipoadm like'" + tipo + "%'";
